...
export class HomepageComponent {
    ...
    activitySectorImages: any = {
        'Transportation and Logistics': 'img',
        'Transporte y Logística': 'img',
        'Bathroom': 'img',
        'Baño': 'img',
        'Carpentry': 'img',
        'Carpintería': 'img',
        ...
        'Closet / Cupboard': 'img',
        'Armarios': 'img',
        'CONTRACT (Others: institutional educational other installations etc.)': 'img',
        'COLECTIVIDADES (Otros: institucionaleducacional otras instalaciones etc.)': 'img',
        'Doors and Windows': 'img',
        'Puertas y Ventanas': 'img',
        'Furniture for Retail': 'img',
        'Muebles para Establecimientos Comerciales': 'img',
        'Home': 'img',
        'Hogar': 'img',
        'HORECA (HOTELSRESTAURANTS & CAFÉS)': 'img',
        'HORECA (HOTELES RESTAURACIÓN y CAFETERÍAS)': 'img',
        'Kids': 'img',
        'Mueble Juvenil': 'img',
        'Kitchen': 'img',
        'Cocina': 'img',
        'Lightings / Lamps': 'img',
        'Iluminación / Lámparas': 'img',
        'Mattresses': 'img',
        'Colchones': 'img',
        'Office': 'img',
        'Oficina': 'img',
        'Outdoor Furniture': 'img',
        'Mueble para Exteriores': 'img',
        'Panels': 'img',
        'Paneles': 'img',
        'Parquet Floors': 'img',
        'Parquet': 'img',
        'Upholstered Furniture': 'img',
        'Mueble Tapizado': 'img',
        'Wooden Packaging': 'img',
        'Embalaje de Madera': 'img',
        'Wooden Structures': 'img',
        'Estructuras de madera': 'img',
        'Retail and Distribution': 'img',
        'Retail y Distribución': 'img',
        'Architects': 'img',
        'Arquitectos': 'img',
        'Buyer-Designer': 'img',
        'Prescriptor': 'img',
        ...
        'Consulting': 'img',
        'Consultoría': 'img',
        'Design / Decoration': 'img',
        'Diseño / Interiorismo': 'img',
        'Distributor': 'img',
        'Distribuidor': 'img',
        'Engineering': 'img',
        'Ingenieria': 'img',
        'Facility Cleaning': 'img',
        'Limpieza Instalaciones': 'img',
        'Facility Maintenance': 'img',
        'Mantenimiento Instalaciones': 'img',
        'Furniture Installer': 'img',
        'Instalador de Muebles': 'img',
        'Legal Services': 'img',
        'Servicios Jurídicos': 'img',
        'Outsourcing': 'img',
        'Subcontratación de Procesos': 'img',
        'Print Services': 'img',
        'Servicios de Impresión': 'img',
        'Quality Control / Tests': 'img',
        'Control de Calidad / Ensayos': 'img',
        'Sales Agent': 'img',
        'Agente Comercial': 'img',
        'Software': 'img',
        'Training': 'img',
        'Formación': 'img',
        'Waste Management': 'img',
        'Gestión de Residuos': 'img',
        'Abrasives': 'img',
        'Lijas y Abrasivos': 'img',
        'Adhesives': 'img',
        'Colas y Adhesivos': 'img',
        'Board': 'img',
        'Tablero': 'img',
        'Ceramic': 'img',
        'Cerámica': 'img',
        'Composites': 'img',
        'Materiales Compuestos': 'img',
        'Cork': 'img',
        'Corcho': 'img',
        'Decorated Paper': 'img',
        'Papel Decorado': 'img',
        'Electronic Components': 'img',
        'Componentes Electrónicos': 'img',
        'Fitting': 'img',
        'Herrajes': 'img',
        'Foam': 'img',
        'Espuma': 'img',
        ...
        'Maquinaria': 'img',
        'Metal': 'img',
        'Packaging Materials': 'img',
        'Materiales de Embalaje': 'img',
        'Paints & Varnishes': 'img',
        'Pinturas y Barnices': 'img',
        'Plastic': 'img',
        'Plástico': 'img',
        'Plywood': 'img',
        'Contrachapado': 'img',
    ...
    private getImageForActivitySector(): string {
        return '';
    }
}
