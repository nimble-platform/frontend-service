...
export class DespatchAdviceComponent {
    ...
    sendDespatchAdvice(): void {
        ...
        let vars: ProcessVariables = ModelUtils.createProcessVariables("Fulfilment", despatchAdvice.despatchSupplierParty.party.id, despatchAdvice.deliveryCustomerParty.party.id, despatchAdvice);
