...
@Component({
    selector: "negotiation-response-input",
    templateUrl: "./negotiation-response-input.component.html",
    styleUrls: ["./negotiation-response-input.component.css"],
})
export class NegotiationResponseInputComponent implements OnInit {

    @Input() negotiating: boolean;
