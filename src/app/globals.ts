...
export const catalogue_endpoint_with_zuul = `http://localhost:8095`;
...
export const indexing_service_endpoint = `http://localhost:8090`;
...
export const config = {
    ...
    "imprint": {
        "en": "<u>Platform Owner & Provider</u><br/><b>SRDC - Software Research & Development Consultancy</b><br/>ODTÜ Teknokent, Silikon Blok No:28<br/>06800 Ankara, Türkiye<br/>E-Mail: <a href='mailto:info@srdc.com.tr'>info@srdc.com.tr</a><br/>Internet: <a href='https://www.srdc.com.tr' target='_blank'>www.srdc.com.tr</a><br/><br/>This platform has been updated for the <b>HarWASTing</b> project (EU Horizon Europe, Grant Agreement No. 101181393).",
        "es": "<u>Propietario de Plataforma y Proveedor</u><br/><b>SRDC - Software Research & Development Consultancy</b><br/>ODTÜ Teknokent, Silikon Blok No:28<br/>06800 Ankara, Türkiye<br/>Correo electrónico: <a href='mailto:info@srdc.com.tr'>info@srdc.com.tr</a><br/>Internet: <a href='https://www.srdc.com.tr' target='_blank'>www.srdc.com.tr</a><br/><br/>Esta plataforma ha sido actualizada para el proyecto <b>HarWASTing</b> (UE Horizonte Europa, Acuerdo de Subvención n.º 101181393)."
    },
...
export const party_facet_field_list = ["legalName", "{LANG}_brandName", "businessType", "{LANG}_activitySectors", "{LANG}_businessKeywords", "en_origin", "circularEconomyCertificates","certificateType", "ppapComplianceLevel", "ppapDocumentType"];
...
export const product_filter_mappings = {
    ...
    "manufacturer.origin": "Supplier Country",
