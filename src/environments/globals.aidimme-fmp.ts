...
export const base_path = "http://testing.aidimme.es";
export const ub_base = "http://testing.aidimme.es/ub-search";
export const idpURL = "http://testing.aidimme.es:8080/auth/realms/master";
...
export const product_filter_comp = ["manufacturer.legalName", "manufacturer.brandName", "manufacturer.businessType", "manufacturer.businessKeywords", "manufacturer.origin", "manufacturer.certificateType"];
